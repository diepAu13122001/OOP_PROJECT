...
public class OrderView extends JFrame implements ActionListener {
    ...
    public void createView() {
        ...
        comboPanel.setPreferredSize(new Dimension(500, 500));
        dealPanel.setPreferredSize(new Dimension(500, 500));
        mainPanel.setPreferredSize(new Dimension(500, 500));
        firedPanel.setPreferredSize(new Dimension(500, 500));
        dessertPanel.setPreferredSize(new Dimension(500, 500));
        coldPanel.setPreferredSize(new Dimension(500, 500));
        teaPanel.setPreferredSize(new Dimension(500, 500));
        coffeePanel.setPreferredSize(new Dimension(500, 500));
        ...
        addItemInComboList();
        addItemInCoffeeList();
        addItemInHotDealList();
        addItemInMainDishList();
        addItemInTeaList();
        addItemInColdDrinkList();
        addItemInDessertList();
        addItemInFiredList();
        setVisible(true);
    }
    ...
    private JPanel createNewDish(String nameOfDish, String price, String imgURL) {
        ...
        try {
            ...
            imageOfDish1.setIcon(new ImageIcon(image.getScaledInstance(200, 120, Image.SCALE_DEFAULT)));
        } catch (IOException e) {
        }
        ...
        dishPanel.addMouseListener(new MouseListener() {
            @Override
    ...
    public void addItemInHotDealList() {
        for (String[] data : this.model.getHotDealList()) {
            dealPanel.add(createNewDish(data[1], data[2], data[3]));
            dealPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInComboList() {
        for (String[] data : this.model.getComboList()) {
            comboPanel.add(createNewDish(data[1], data[2], data[3]));
            comboPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInMainDishList() {
        for (String[] data : this.model.getMainDishList()) {
            mainPanel.add(createNewDish(data[1], data[2], data[3]));
            mainPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInColdDrinkList() {
        for (String[] data : this.model.getColdDrinkList()) {
            coldPanel.add(createNewDish(data[1], data[2], data[3]));
            coldPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInCoffeeList() {
        for (String[] data : this.model.getCoffeeList()) {
            coffeePanel.add(createNewDish(data[1], data[2], data[3]));
            coffeePanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInTeaList() {
        for (String[] data : this.model.getTeaList()) {
            teaPanel.add(createNewDish(data[1], data[2], data[3]));
            teaPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInFiredList() {
        for (String[] data : this.model.getFiredFoodList()) {
            firedPanel.add(createNewDish(data[1], data[2], data[3]));
            firedPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }

    public void addItemInDessertList() {
        for (String[] data : this.model.getDessertList()) {
            dessertPanel.add(createNewDish(data[1], data[2], data[3]));
            dessertPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        }
    }
